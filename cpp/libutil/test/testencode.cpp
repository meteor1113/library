...
void Test()
{
    ...
    {
        std::string gbk = util::WideToGbk(TEST_WSTR);
        std::string str = util::GbkToUtf8(gbk.c_str());
        std::cout << TEST_STR << " -> " << str << std::endl;
        std::cout << "srclen=" << gbk.length() << "    "
                  << "len=" << str.length() << std::endl;
    }
#ifndef __MINGW32__
    std::cout << std::endl << "Utf8ToWide----------------:" << std::endl;
    {
        std::wstring str = util::Utf8ToWide(TEST_STR);
    ...
    {
        std::string str = util::Utf8ToGbk(TEST_STR);
    ...
    {
        std::string gbk = util::WideToGbk(TEST_WSTR);
        std::wstring str = util::GbkToWide(gbk.c_str());
        std::wcout << TEST_WSTR << L" -> " << str << std::endl;
        std::cout << "srclen=" << gbk.length() << "    "
                  << "len=" << str.length() << std::endl;
    }
